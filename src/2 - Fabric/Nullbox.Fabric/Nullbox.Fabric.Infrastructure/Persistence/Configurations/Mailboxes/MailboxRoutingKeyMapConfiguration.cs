...
public class MailboxRoutingKeyMapConfiguration : IEntityTypeConfiguration<MailboxRoutingKeyMap>
{
    public void Configure(EntityTypeBuilder<MailboxRoutingKeyMap> builder)
    {
