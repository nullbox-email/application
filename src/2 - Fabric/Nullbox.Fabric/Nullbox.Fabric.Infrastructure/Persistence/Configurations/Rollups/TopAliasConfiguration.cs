...
public class TopAliasConfiguration : IEntityTypeConfiguration<TopAlias>
{
    public void Configure(EntityTypeBuilder<TopAlias> builder)
    {
        builder.ToContainer("Rollups");
    ...
    public static void ConfigureItems(OwnedNavigationBuilder<TopAlias, TopAliasItem> builder)
    {
        builder.WithOwner()
                .HasForeignKey(x => x.TopAliasId);

        builder.Property(x => x.TopAliasId)
            .IsRequired();
