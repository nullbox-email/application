...
public class ProcessStatisticsCommand : IRequest, ICommand
{
    public ProcessStatisticsCommand(Guid id,
        string partitionKey,
        Guid? aliasId,
        Guid? mailboxId,
        Guid? accountId,
        ...
        ProcessStatisticsCommandDropReasonDto? dropReason,
        ProcessStatisticsCommandQuarantineReasonDto? quarantineReason,
        string? forwardTo,
        string? forwardFrom,
        string? provider,
    ...
    public ProcessStatisticsCommandDropReasonDto? DropReason { get; set; }
    public ProcessStatisticsCommandQuarantineReasonDto? QuarantineReason { get; set; }
