...
public class ProcessRollupsCommandValidator : AbstractValidator<ProcessRollupsCommand>
{
    public ProcessRollupsCommandValidator(IValidatorProvider provider)
    {
    ...
    private void ConfigureValidationRules(IValidatorProvider provider)
    {
        ...
        RuleFor(v => v.DropReason)
            .SetValidator(provider.GetValidator<ProcessRollupsCommandDropReasonDto>()!);

        RuleFor(v => v.QuarantineReason)
            .SetValidator(provider.GetValidator<ProcessRollupsCommandQuarantineReasonDto>()!);
