...
public class ProcessRollupsCommand : IRequest, ICommand
{
    public ProcessRollupsCommand(Guid id,
        string partitionKey,
        Guid? aliasId,
        Guid? mailboxId,
        Guid? accountId,
        ...
        ProcessRollupsCommandDropReasonDto? dropReason,
        ProcessRollupsCommandQuarantineReasonDto? quarantineReason,
        string? forwardTo,
        string? forwardFrom,
        string? provider,
    ...
    public ProcessRollupsCommandDropReasonDto? DropReason { get; set; }
    public ProcessRollupsCommandQuarantineReasonDto? QuarantineReason { get; set; }
