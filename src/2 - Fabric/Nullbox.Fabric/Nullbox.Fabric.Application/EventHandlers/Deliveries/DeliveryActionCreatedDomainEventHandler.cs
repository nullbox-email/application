...
public class DeliveryActionCreatedDomainEventHandler : INotificationHandler<DomainEventNotification<DeliveryActionCreatedDomainEvent>>
{
    private readonly IMessageBus _messageBus;

    public DeliveryActionCreatedDomainEventHandler(IMessageBus messageBus)
    {
        _messageBus = messageBus;
    }

    public async Task Handle(
            DomainEventNotification<DeliveryActionCreatedDomainEvent> notification,
            CancellationToken cancellationToken)
    {
        //var domainEvent = notification.DomainEvent;
        //_messageBus.Publish(new DeliveryActionCreatedV1Event
        //{
