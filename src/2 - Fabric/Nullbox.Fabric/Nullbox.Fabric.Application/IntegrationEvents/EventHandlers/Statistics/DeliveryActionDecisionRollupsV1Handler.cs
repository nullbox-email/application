...
public class DeliveryActionDecisionRollupsV1Handler : IIntegrationEventHandler<DeliveryActionDecisionRollupsV1>
{
    private readonly ISender _mediator;

    public DeliveryActionDecisionRollupsV1Handler(ISender mediator)
    {
        _mediator = mediator ?? throw new ArgumentNullException(nameof(mediator));
    }

    public async Task HandleAsync(
DeliveryActionDecisionRollupsV1 message,
