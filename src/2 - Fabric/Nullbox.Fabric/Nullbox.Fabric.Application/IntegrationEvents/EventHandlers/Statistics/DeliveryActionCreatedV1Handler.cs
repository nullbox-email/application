...
public class DeliveryActionCreatedV1Handler : IIntegrationEventHandler<DeliveryActionCreatedV1Event>
{
    private readonly IMessageBus _messageBus;

    public DeliveryActionCreatedV1Handler(IMessageBus messageBus)
    {
        _messageBus = messageBus;
    }

    public async Task HandleAsync(DeliveryActionCreatedV1Event message, CancellationToken cancellationToken = default)
    {
        _messageBus.Send(new DeliveryActionCreateActivitiesV1
        {
            Id = message.Id,
        ...
        _messageBus.Send(new DeliveryActionCreateRollupsV1
        {
            Id = message.Id,
            PartitionKey = message.PartitionKey,
            AliasId = message.AliasId,
        ...
        _messageBus.Send(new DeliveryActionCreateStatisticsV1
        {
            Id = message.Id,
            PartitionKey = message.PartitionKey,
            AliasId = message.AliasId,
