...
public class DeliveryActionCompletedV1Handler : IIntegrationEventHandler<DeliveryActionCompletedV1Event>
{
    private readonly IMessageBus _messageBus;
    public DeliveryActionCompletedV1Handler(IMessageBus messageBus)
    {
        _messageBus = messageBus;
    }

    public async Task HandleAsync(
            DeliveryActionCompletedV1Event message,
            CancellationToken cancellationToken = default)
    {
        _messageBus.Send(new DeliveryActionCompleteActivitiesV1
        {
            Id = message.Id,
        ...
        _messageBus.Send(new DeliveryActionCompleteRollupsV1
        {
            Id = message.Id,
            PartitionKey = message.PartitionKey,
            AliasId = message.AliasId,
        ...
        _messageBus.Send(new DeliveryActionCompleteStatisticsV1
        {
            Id = message.Id,
            PartitionKey = message.PartitionKey,
            AliasId = message.AliasId,
