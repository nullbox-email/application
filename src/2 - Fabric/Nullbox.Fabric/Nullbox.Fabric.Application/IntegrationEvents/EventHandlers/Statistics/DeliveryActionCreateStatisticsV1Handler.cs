...
public class DeliveryActionCreateStatisticsV1Handler : IIntegrationEventHandler<DeliveryActionCreateStatisticsV1>
{
    private readonly ISender _mediator;

    public DeliveryActionCreateStatisticsV1Handler(ISender mediator)
    {
        _mediator = mediator ?? throw new ArgumentNullException(nameof(mediator));
    }

    public async Task HandleAsync(
DeliveryActionCreateStatisticsV1 message,
