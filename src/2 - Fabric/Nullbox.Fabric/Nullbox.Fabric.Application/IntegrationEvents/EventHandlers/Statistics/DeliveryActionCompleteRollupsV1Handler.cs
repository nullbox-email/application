...
public class DeliveryActionCompleteRollupsV1Handler : IIntegrationEventHandler<DeliveryActionCompleteRollupsV1>
{
    private readonly ISender _mediator;

    public DeliveryActionCompleteRollupsV1Handler(ISender mediator)
    {
        _mediator = mediator ?? throw new ArgumentNullException(nameof(mediator));
    }

    public async Task HandleAsync(
DeliveryActionCompleteRollupsV1 message,
