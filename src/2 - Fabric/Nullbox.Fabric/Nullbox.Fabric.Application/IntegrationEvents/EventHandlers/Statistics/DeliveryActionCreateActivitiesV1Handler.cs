...
public class DeliveryActionCreateActivitiesV1Handler : IIntegrationEventHandler<DeliveryActionCreateActivitiesV1>
{
    private readonly ISender _mediator;

    public DeliveryActionCreateActivitiesV1Handler(ISender mediator)
    {
        _mediator = mediator ?? throw new ArgumentNullException(nameof(mediator));
    }

    public async Task HandleAsync(
DeliveryActionCreateActivitiesV1 message,
