...
public class DeliveryActionCompleteProcessAccountActivitiesV1Handler : IIntegrationEventHandler<DeliveryActionCompleteProcessAccountActivitiesV1>
{
    private readonly ISender _mediator;

    public DeliveryActionCompleteProcessAccountActivitiesV1Handler(ISender mediator)
    {
