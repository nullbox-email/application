...
public class DeliveryActionDecisionStatisticsV1Handler : IIntegrationEventHandler<DeliveryActionDecisionStatisticsV1>
{
    private readonly ISender _mediator;

    public DeliveryActionDecisionStatisticsV1Handler(ISender mediator)
    {
        _mediator = mediator ?? throw new ArgumentNullException(nameof(mediator));
    }

    public async Task HandleAsync(
DeliveryActionDecisionStatisticsV1 message,
