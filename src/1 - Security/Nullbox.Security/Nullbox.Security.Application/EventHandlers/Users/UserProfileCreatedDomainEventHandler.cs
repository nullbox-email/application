...
public class UserProfileCreatedDomainEventHandler : INotificationHandler<DomainEventNotification<UserProfileCreatedDomainEvent>>
{
    private readonly IMessageBus _messageBus;
    public UserProfileCreatedDomainEventHandler(IMessageBus messageBus)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        _messageBus.Publish(new UserProfileCreatedV1Event
        {
            Id = domainEvent.UserProfile.Id,
            Name = domainEvent.UserProfile.Name,
            EmailAddress = new UserProfileCreatedV1EmailAddressDto
            {
