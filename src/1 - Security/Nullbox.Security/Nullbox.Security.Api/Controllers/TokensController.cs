...
using Nullbox.Security.Application.Tokens;
using Nullbox.Security.Application.Tokens.ExchangeToken;
using Nullbox.Security.Application.Tokens.RequestAccessToken;
...
public class TokensController : ControllerBase
{
    ...
    /// <response code="401">Unauthorized request.</response>
    /// <response code="403">Forbidden request.</response>
    [HttpPost("/v{version:apiVersion}/tokens/access")]
    [ProducesResponseType(typeof(TokenContractDto), StatusCodes.Status201Created)]
    ...
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
    [MapToApiVersion("1.0")]
    public async Task<ActionResult<TokenContractDto>> RequestAccessToken(
            [FromBody] RequestAccessTokenCommand command,
