...
using Nullbox.Auth.EntraExternalId.Application.Common.Pagination;
using Nullbox.Auth.EntraExternalId.Domain.Common.Interfaces;
using Nullbox.Auth.EntraExternalId.Domain.Repositories;

[assembly: IntentTemplate("Intent.EntityFrameworkCore.Repositories.RepositoryBase", Version = "1.0")]

namespace Nullbox.Auth.EntraExternalId.Infrastructure.Repositories;
